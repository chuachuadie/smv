...
public class GeneratorCode {
    private static String author ="mingtian";//作者名称
    private static String outputDir ="C:\\Users\\mingmin\\Documents\\IntelliJ IDEA workspace\\cnasDemo01\\src\\main\\java\\com\\cnas\\";//生成的位置
    private static String driver ="com.mysql.cj.jdbc.Driver";//驱动，注意版本
    //连接路径,注意修改数据库名称
    private static String url ="jdbc:mysql://localhost:3306/cnas?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";
    ...
    private static String parentPackage = "com.cnas";//顶级包结构
